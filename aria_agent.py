# app.py — ARIA (stable, lisible & futuriste)
# Dépendances minimales : streamlit, plotly
# Optionnel pour PDF : reportlab (pip install reportlab)
# Optionnel pour auto-refresh : streamlit-extras (pip install streamlit-extras)
...
BASE_CSS = """
<style>
/* Immersion (masque topbar) — retire cette ligne si tu veux garder la barre */
...
/* Fond animé: halos + grille (performant) */
.main::before{
...
/* Variante jaune (si besoin) */
.title-yellow{ color:#fde047 !important; } /* amber-300 */
...
/* Plotly (labels clairs) */
.js-plotly-plot, .plot-container { color:#eaf0ff !important; }
...
with top4:
    ...
    set_background_image(BG_URL, overlay_opacity=0.32 if BG_URL else 0.0)
...
# Auto-refresh (fix AttributeError)
if autonomous:
    try:
